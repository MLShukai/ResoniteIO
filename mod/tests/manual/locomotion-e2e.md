...
(`memory/feedback_locomotion_external_input.md` §2 参照)。
...
git log と `memory/feedback_locomotion_external_input.md` §2 で
確認する。
...
engine 側落とし穴の正典は
[`feedback_locomotion_external_input.md`](../../../memory/feedback_locomotion_external_input.md)。
