...
Inventory/Manipulation) がこの形に統一済み。label 文言は既存ログと一致させる
...
**Manipulation 注意:** RequireBridge/InvokeBridge の 2 分割は house style
(\[\[manipulation-service-no-handleasync\]\])。translate の 1 case を helper に畳むのは
