...
- [argparse subparser default overwrite](argparse_subparser_default_overwrite.md) — nested subparser leaf defaults clobber parent-parsed flags; use flat optional positional (cf. cli/grabber.py)
