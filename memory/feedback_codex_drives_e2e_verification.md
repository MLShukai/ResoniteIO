...
description: e2e 検証の実行主体は Codex。container 内で Resonite を自動駆動するのが基本で、manual 手順書はユーザが読まない前提で書き起こさない。
metadata:
  type: feedback
---
...
- 新規モダリティ / 新規機能の検証は、まず Codex が container 内で回せる自動 e2e (`python/tests/e2e/<modality>.py` 形式) として書く
